...
public class Test1calcu extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Calculator java
     */
                    ...
                    if(oprClickCount == 0)// if an operation is clicked for the first time
                    {
                        ...
                        if(!button.getText().equals("="))// if the operation is not '='
                        {
                            if(!isEqualClick)
                            {
                                ...
                                jTextField1.setText(Float.toString(calcu(opr, num1, num2)));
                                opr = button.getText();
                                num2 = Float.valueOf(jTextField1.getText());
                                isOprClick = true;
                                isEqualClick = false;
    ...
    // calcu two numbers and return the result
    public float calcu(String op, float n1, float n2)
    {
        float result = 0;
    ...
    private void initComponents() {
        ...
        jButton3.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton3.setText("/");
        ...
        jButton7.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton7.setText("*");
        ...
        jButton11.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton11.setText("-");

        jButton12.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton12.setText("0");

        jButton13.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton13.setText(".");

        jButton14.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton14.setText("=");

        jButton15.setFont(new java.awt.Font("Serif", 0, 22)); // NOI18N
        jButton15.setText("+");
        ...
        jButton17.setFont(new java.awt.Font("Serif", 0, 15)); // NOI18N
        ...
        jButton18.setFont(new java.awt.Font("Serif", 0, 15)); // NOI18N
